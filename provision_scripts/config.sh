...
CADENA_METAPAQUETE_LAMP="apache2 mariadb-server mariadb-common php php-cli libapache2-mod-php php-mysql php-gd php-xml curl lynx php-dev libmcrypt-dev php-curl php-soap php-zip"
